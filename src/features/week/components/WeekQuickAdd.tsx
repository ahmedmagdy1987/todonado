  ...
  if (!open) {
    return (
      <button
        ...
        className="focus-ring flex w-full items-center gap-1.5 rounded-lg px-2 py-1.5 text-xs text-text-muted transition-colors hover:bg-surface-2/60 hover:text-text-primary"
      >
